def call(Map config = [:]) {
    ...
    sh 'pwd'
    def response = httpRequest authentication: 'nexusrepositorycreds', url: "${nexusUrl}service/rest/v1/search?repository=ria-spa-repo&group=/epm-spa-integration&name=epm-spa-integration/epm-integration-2023.07*"
    echo ${response}
